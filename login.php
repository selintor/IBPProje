...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <h1 class="text-center py-5 login-title"><b>User Login</b></h1>
      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="email" name="email" id="email" autofocus placeholder="Email" class="form-control form-control-border" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <button class="btn btn-default bg-primary btn-flat"> Login</button>
                                    <a href="./" class="btn btn-default bg-default btn-flat"> Cancel</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
