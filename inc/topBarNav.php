...
<!-- Navbar -->
      ...
      <nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-dark-subtle" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=search" class="nav-link <?= isset($page) && $page =='search' ? "active" : "" ?>">Search Movie</a>
              </li>
              <li class="nav-item">
